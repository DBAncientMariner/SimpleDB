...
public class Buffer {
	...
	/**
	 * Saves the current buffers content as backup.
	 * 
	 * @return returns the block number at the position the block is backed up.
	...
	/**
	 * Restores this buffer with the specified block and the block number from
	 * the backup file to be restored.
	 * 
	 * @param tobeRestored
	 *            Actual DB block to be restored
	 * @param blocknum
